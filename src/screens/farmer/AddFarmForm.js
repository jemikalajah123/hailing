                                ...
                                <div className="card-block">
                                    <form onSubmit={onSubmit}>
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control" name='farmName' value={farmName} onChange={e => setFarmName(e.target.value)}  placeholder="Ajayi Farms"  required/>
                                        </div>
                                        <div class="form-group">
                                            <label htmlFor="farmType" class="form-control-label">Farm Type</label>
                                                <select className="form-control " name="farmType" id="farmType" onChange={e => setFarmType(e.target.value)}>
                                                {farmTypes !== null ?
                                        ...
                                        <div class="form-group">
                                            <label htmlFor="farmState" class="form-control-label">Farm State</label>
                                                <select className="form-control " name="farmState" id="farmState" onChange={e => setFarmState(e.target.value)}>
                                                    {farmStates !== null ?
                                        ...
                                        <div class="form-group">
                                            <label htmlFor="farmLga" class="form-control-label">Farm Lga</label>
                                                <select className="form-control " name="farmLga" id="farmState" onChange={e => setFarmLga(e.target.value)}>
                                                    {farmLgas !== null ?
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control" name='farmAddress' value={farmAddress} onChange={e => setFarmAddress(e.target.value)}  placeholder="No 3, Hebert Perkins Street, Lekki"  required/>
                                        </div>
